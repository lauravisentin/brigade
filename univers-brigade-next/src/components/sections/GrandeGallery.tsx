...
/*
type pour mes données.
je préfère typer dès le début pour éviter les bugs.
href optionnel -> certaines images sont juste décoratives.
*/
...
/*Destructuration des props pour typage clair et éviter les erreurs.
items = tableau de ressources à afficher.
*/
export default function GrandeGallery({ items }: { items: Ressource[] }) {
                ...
                {items.map((it, i) => {
                    ...
                    */
                    const className = clsx(
                        "animGallery__card",
                        `animGallery__card--${it.variant ?? "default"}`, // nombre de ressources illimité
